export default function Footer() {
  return (
    <footer className="bg-navy pt-8 px-9">
      <div className="flex items-start justify-between gap-10 pb-7">
        <div>
          ...
          <div className="text-[9px] tracking-[0.16em] uppercase text-white/25 mb-4">
          ...
          <div className="flex gap-1.5">
            <a href="https://x.com" target="_blank" className="w-7 h-7 border border-white/15 flex items-center justify-center">
              <svg className="w-3 h-3 fill-white/40" viewBox="0 0 24 24">
