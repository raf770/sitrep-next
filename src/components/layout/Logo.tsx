...
export default function Logo() {
  return (
    <div className="bg-sand px-9 py-4 border-b border-[#d8d2c8] flex items-center justify-between">
      <div>
        <Link href="/">
          <div className="font-barlow text-5xl font-black tracking-wide text-navy leading-none">
