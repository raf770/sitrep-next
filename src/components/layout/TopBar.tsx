...
export default function TopBar() {
  ...
  return (
    <div className="bg-navy h-9 px-9 flex items-center justify-between">
      <div className="flex items-center gap-4">
        <span className="text-[10px] tracking-wide text-white/45">{date}</span>
        <span className="flex items-center gap-1 text-[10px] font-bold uppercase text-[#e05a5a]">
          <span className="w-1.5 h-1.5 rounded-full bg-[#e05a5a] animate-pulse" />
          Live
        </span>
      </div>
