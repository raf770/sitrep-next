    ...
    <>
      ...
      <div className="grid grid-cols-3 border border-[#c8c0b0] mb-9 overflow-hidden bg-white">
        {articles.map((a, i) => (
          ...
          >
            <img
              src={a.image || "https://images.unsplash.com/photo-1521295121783-8a321d551ad2?w=600&q=70"}
              alt={a.title}
              className="w-full h-[150px] object-cover brightness-[0.78] saturate-75"
            ...
            <div className="p-4">
              ...
              <div className="text-[15px] font-bold text-navy leading-snug mb-1.5">{a.title}</div>
              <div className="text-xs text-muted leading-relaxed font-light mb-3">{a.extrait}</div>
